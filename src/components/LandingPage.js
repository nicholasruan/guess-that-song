	...
	render() {
		return(
			<div className="App">
				...
				<p id="landing-text">How well do you know your music? Test your musical knowledge across multiple genres and tracks. This app was inspired by the built-in iPod game ‘Music Quiz’.</p>
